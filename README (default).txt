...
TumeniNodes (CC BY-SA 3.0):
  ...
  default_chest_side.png, based on texture by BlockMen (CC BY-SA 3.0)
  default_chest_top.png, based on texture by BlockMen (CC BY-SA 3.0)
  default_bookshelf.png, based on a texture by celeron55, Perttu Ahola (CC BY-SA 3.0)
